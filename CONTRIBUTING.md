...
2. Fork the repository (https://github.com/zendframework/zend-expressive-platesrenderer)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/zend-expressive-platesrenderer.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/zend-expressive-platesrenderer.git
